...
then
    ...
    /system/bin/insmod /system/bin/wifi_brcm/driver/dhd.ko firmware_path=/system/bin/wifi_brcm/firmware/rtecdc_vsdb.bin.trx nvram_path=/system/bin/wifi_brcm/nv/bcm4356.nv
else
    echo "product is $PRODUCTNAME"
    /system/bin/insmod /system/bin/wifi_brcm/driver/dhd.ko firmware_path=/system/bin/wifi_brcm/firmware/rtecdc_vsdb.bin.trx nvram_path=/system/bin/wifi_brcm/nv/bcm4356_$PRODUCTNAME.nv
fi
else
    echo "dhd is valid"
fi
